...
- **Account Dashboard**: Tab-based layout (Overview, Profile, Subscription, Entries, Settings). Overview shows stats cards + quick info. Profile tab has card preview + editor + badges. Subscription tab has 3-tier pricing (Silver ₹199, Gold ₹499, Black ₹999). Entries tab lists giveaway history. Settings tab has appearance/themes + notifications + account management.
