      ...
      <main className="relative z-10 pt-[70px] pb-16 sm:pb-24">
        <div className="container mx-auto px-4 max-w-2xl pt-8 sm:pt-12">
          ...
          >
            <Link
              href="/giveaway"
              className="inline-flex items-center gap-1.5 text-[11px] sm:text-xs font-display text-foreground/45 hover:text-foreground/80 transition-colors"
            >
            ...
            <div className="relative z-[2] p-6 sm:p-9">
              ...
              <div className="text-center mb-5">
                <div className="glass-pill-badge inline-flex">
                  <Shield className="w-3 h-3 mr-2 text-foreground/60" />
                  Verified Entry Lookup
                </div>
              </div>

              {/* Title */}
              <h1 className="text-center text-2xl sm:text-3xl md:text-4xl font-display font-light text-foreground mb-3 leading-[1.15] tracking-tight">
                Check Your Entry
              </h1>
              <p className="text-center text-foreground/50 text-xs sm:text-sm font-light leading-relaxed max-w-md mx-auto mb-7">
              ...
              <div className="space-y-3">
                <label htmlFor="entry-code" className="block">
                  <span className="block text-[10px] uppercase tracking-[0.18em] text-foreground/35 font-display mb-2">
                    Entry Code
                  </span>
                  <div className="relative">
                    <Hash className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-foreground/25" />
                    <input
                      id="entry-code"
                      type="text"
                      value={code}
                      ...
                      autoComplete="off"
                      autoFocus
                      className="w-full pl-11 pr-4 py-3.5 rounded-2xl text-sm sm:text-base text-foreground placeholder-white/20 font-mono tracking-wider focus:outline-none transition-all"
                      style={{
                ...
                <button
                  ...
                  className="w-full inline-flex items-center justify-center gap-2 py-3.5 rounded-2xl text-sm font-display font-medium text-foreground transition-all disabled:opacity-40 disabled:cursor-not-allowed"
                  style={{
                ...
                >
                  <div className="p-5">
                    <div className="flex items-center gap-2 mb-4">
                      ...
                      >
                        <CheckCircle2 className="w-4 h-4 text-foreground/85" />
                      </div>
                      <div>
                        <div className="text-[10px] uppercase tracking-[0.18em] text-foreground/45 font-display">Status</div>
                        <div className="text-sm font-display text-foreground">Entry Verified</div>
                      </div>
                    </div>
              ...
              <div className="mt-6 pt-5 border-t" style={{ borderColor: "rgba(255,255,255,0.06)" }}>
                <div className="flex items-center justify-center gap-4 text-[10px] sm:text-[11px] text-foreground/40 font-light">
                  <span className="inline-flex items-center gap-1.5">
                    <Sparkles className="w-3 h-3 text-foreground/35" />
                    Instant verification
                  </span>
                  <span className="w-px h-3 bg-white/10" />
                  <span className="inline-flex items-center gap-1.5">
                    <Trophy className="w-3 h-3 text-foreground/35" />
                    Privacy protected
                  </span>
                </div>
              </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-[11px] text-foreground/35 font-light">
              ...
              <Link href="/giveaway" className="text-foreground/70 hover:text-foreground underline-offset-4 hover:underline transition-colors">
                Browse contests
              </Link>
            </p>
          </div>
...
function ResultField({ icon, label, value, mono }: { icon: React.ReactNode; label: string; value: string; mono?: boolean }) {
  return (
    ...
    >
      ...
      <div
        className={`text-xs sm:text-sm text-foreground/85 truncate ${mono ? "font-mono tracking-wider" : "font-light"}`}
        title={value}
      >
        {value}
      </div>
