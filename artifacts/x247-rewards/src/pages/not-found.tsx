...
const SUGGESTIONS = [
  {
    ...
    icon: Gift,
    title: "Giveaways",
    desc: "Live draws & daily prizes",
  },
  {
    href: "/winners",
    icon: Trophy,
    title: "Winners",
    desc: "See who took home the loot",
  },
  {
    href: "/pricing",
    icon: Crown,
    title: "Membership",
    desc: "Silver · Gold · Black tiers",
  },
  {
    href: "/community",
    icon: Users,
    title: "Community",
    desc: "Players, profiles & leaderboards",
  },
];
      ...
      <div className="x404">
        ...
        >
          ...
          >
            ...
            <span className="x404-title-italic">disappeared</span>
          </motion.h2>
          ...
          >
            ...
            moved. Try one of the destinations below — or just head home.
          </motion.p>
          ...
          >
            ...
            <div className="x404-terminal-body">
              ...
              <div className="x404-term-line x404-term-line-muted">
                ...
                <span className="x404-term-path">
                  try /giveaway · /winners · /pricing
                </span>
              </div>
            </div>
          </motion.div>
                ...
                {filtered.map((r, i) => {
                  ...
                  return (
                    <Link
                      key={`${r.href}-${i}`}
                      href={r.href}
                      className="x404-search-result"
                    >
                      <Icon className="w-3.5 h-3.5" />
                      <span className="x404-search-result-title">
                        {r.title}
                      </span>
          ...
          >
            ...
            <button
              ...
              className="x404-btn x404-btn-secondary"
            >
