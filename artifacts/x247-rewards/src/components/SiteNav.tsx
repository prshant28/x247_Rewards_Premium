...
interface SiteNavProps {
  activePage?: "home" | "partners" | "offers" | "partner-detail" | "giveaway" | "winners" | "account" | "community" | "referral" | "how-it-works";
}
      ...
      items={[
        ...
        },
        {
          ...
          links: [
            ...
            { label: "How it Works", href: "/how-it-works", spa: true, icon: <Target className="w-3.5 h-3.5" /> },
